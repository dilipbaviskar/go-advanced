...
import (
	...
	_ "github.com/lib/pq"
	"github.com/dilipbaviskar/go-distsys/gokitdemo/pkg/oc"

	"github.com/dilipbaviskar/go-distsys/gokitdemo/services/order"
	"github.com/dilipbaviskar/go-distsys/gokitdemo/services/order/cockroachdb"
	ordersvc "github.com/dilipbaviskar/go-distsys/gokitdemo/services/order/implementation"
	"github.com/dilipbaviskar/go-distsys/gokitdemo/services/order/middleware"
	"github.com/dilipbaviskar/go-distsys/gokitdemo/services/order/transport"
	httptransport "github.com/dilipbaviskar/go-distsys/gokitdemo/services/order/transport/http"
)
...
func main() {
	...
	var db *sql.DB
	{
		...
		db, err = sql.Open("postgres",
			"postgresql://mylocaluser@localhost:26257/ordersdb?sslmode=disable")
		if err != nil {
