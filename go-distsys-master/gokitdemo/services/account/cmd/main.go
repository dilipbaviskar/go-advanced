...
import (
	...
	// internal
	"github.com/dilipbaviskar/go-distsys/gokitdemo/services/account"
	"github.com/dilipbaviskar/go-distsys/gokitdemo/services/account/cockroachdb"
	accountsvc "github.com/dilipbaviskar/go-distsys/gokitdemo/services/account/implementation"
	"github.com/dilipbaviskar/go-distsys/gokitdemo/services/account/transport"
	grpctransport "github.com/dilipbaviskar/go-distsys/gokitdemo/services/account/transport/grpc"
	"github.com/dilipbaviskar/go-distsys/gokitdemo/services/account/transport/pb"
)

const (
	port     = ":50051"
	dbsource = "postgresql://dilipbaviskar@localhost:26257/ordersdb?sslmode=disable"
)
