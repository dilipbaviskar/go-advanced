...
#### Create user
cockroach user set mylocaluser --insecure

#### Create Database
cockroach sql --insecure -e 'CREATE DATABASE ordersdb'

#### Grant privileges to the mylocaluser user
cockroach sql --insecure -e 'GRANT ALL ON DATABASE ordersdb TO mylocaluser'
...
cockroach sql \
--url="postgresql://mylocaluser@localhost:26257/ordersdb?sslmode=disable";
