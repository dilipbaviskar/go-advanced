...
import (
	...
	"github.com/dilipbaviskar/gokit/examples/http-app/pkg/auth"
	"github.com/dilipbaviskar/gokit/examples/http-app/pkg/controller"
	"github.com/dilipbaviskar/gokit/examples/http-app/pkg/postgres"
)
